                      ...
                      <div class="span6">
                        ...
                        <div class="btn-group">
                            <button class="btn" data-toggle="dropdown">
                              <i class="icon-search"></i> <strong>Por archivo</strong> <span class="caret"></span>
                            </button>
            ...
            while($dato=mysql_fetch_array($can)){	
			  ...
			  ?>
                  <tr>
                    ...
                    <td>
                    	<a href="ingresar_a_personal.php?actualizar=<?php echo $dato['id']; ?>" class="btn btn-mini" title="Modificar">
                    		<i class="icon-edit"></i>
                        </a>
                    </td>
                  </tr>
