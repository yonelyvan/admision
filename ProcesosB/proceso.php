      ...
      <tr>
        <td>
        	...
        	<table class="table table-bordered table table-hover">
              <tr class="success">
                <td width="23%"><center><strong>Proceso</strong></center></td>
                <td width="23%"><center><strong>Cantidad de Vacantes</strong></center></td>
                <td width="14%"><center><strong>Fecha 1</strong></center></td>
                <td width="14%"><center><strong>Fecha 2</strong></center></td>
                <td width="18%"><center><strong>Fecha Opcional</strong></center></td>
                <td width="15%"><center><strong>Gastos</strong></center></td>
			  ...
			  ?>
                  <tr>
                    <td><i class="icon-user"></i> <?php echo trim($dato['nombre']); ?></td>
                      <td><i class="icon-tags"></i> <?php echo trim($dato['cantidad_vacantes']); ?></td>
                      <td><?php echo trim($dato['fecha_1']); ?></td>
                      <td><i class="icon-USD"></i> <?php echo trim($dato['fecha_2']); ?></td>
                      <td><i class="icon-eye-open"></i> <?php echo trim($dato['fecha_opcinal']); ?></td>
                      <td> <?php echo trim($dato['gastos']); ?></td>
                    <td>
                    	<a href="ingresar_proceso.php?id=<?php echo $dato['id']; ?>" class="btn btn-mini" title="Modificar Cargo">
                    		<i class="icon-edit"></i>
                        </a>
                    </td>
                  </tr>
