<?php
		...
		if(!empty($_GET['id']))
        {
            ...
            {				
		        ...
		        $nombre=$row['nombre'];				$cantidad_vacantes=$row['cantidad_vacantes'];			$fecha_1=$row['fecha_1'];			$fecha_2=$row['fecha_2'];        $fecha_opcinal=$row['fecha_opcinal'];        $gastos=$row['gastos'];
      ...
      <tr>
		...
		<?php 
            if(!empty($_POST['id']))
            {
                ...
                $fecha_opcinal=limpiar($_POST['fecha_opcinal']);    $gastos=limpiar($_POST['gastos']);
               
                
                if($existe==FALSE){
                    
                    $oProceso=new Proceso('',$nombre,$cantidad_vacantes,$fecha_1_asignado,$fecha_2,$fecha_opcinal, $gastos);						
                    $oProceso->crear();
                
                    
                    
                    echo mensajes('El Proceso "'.$nombre.'" Ha Sido Registrado Con Exito','verde');
                }
                else
                ...
                if($existe==TRUE)
                {
                    ...
                    $oProceso=new Proceso($id,$nombre,$cantidad_vacantes,$fecha_1_asignado,$fecha_2,$fecha_opcinal, $gastos);						
                    $oProceso->actualizar();
    	
                    
                    
                    echo mensajes('El Proceso "'.$nombre.'" Ha Sido Actualizado Con Exito','verde');
                }
            }
        ?>
                ...
                <td>
                	...
                	<div class="row-fluid">
                        <div class="span6">
                            ...
                            <input type="text" name="gastos" value="<?php echo $gastos; ?>" class="input-xxlarge" autocomplete="off"><br>
                        </div>
                        <div class="span6">
                            ...
                            <input type="date" name="fecha_opcinal" value="<?php echo $fecha_opcinal; ?>" autocomplete="off"  class="input-large">
