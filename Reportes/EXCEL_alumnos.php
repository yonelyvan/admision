...
<table width="100%" border="1">
  ...
  <tr>
    ...
    <td width="11%"><strong>Direccion</strong></td>
  ...
  <?php
  	$n=0;$pensionN=0;
  	if($_POST['curso']<>'X'){
  		$sql="SELECT * FROM alumnos WHERE salon='$id_curso' and estado='s'";		  	
	}else{
	...
	while($dato=mysql_fetch_array($can)){
		...
		$salones = new Consultar_Salones($dato['salon']);
        ?>
        <tr>
            ...
            <td><div align="right">S/. <?php echo number_format($dato['pension']); ?></div></td>
        </tr>
  <?php } ?>
  <tr>
    <td colspan="8"><div align="right"><strong>Total Acomulado</strong></div></td>
    <td><div align="right"><strong>S/. <?php echo number_format($pensionN); ?></strong></div></td>
  </tr>
