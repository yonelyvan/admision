<?php
		...
		if(!empty($_GET['codigo']))
        {
			...
			$sql=mysql_query("SELECT * FROM personal WHERE codigo='$codigo'");
			
            if($row=mysql_fetch_array($sql))
            {				
                $existe=TRUE;			$titulo='Actualizar Personal';
                $codigo=$row['codigo'];
		        $nombre=$row['nombre'];
		...
		<?php 
            if(!empty($_POST['codigo']))
            {
                ...
                if($existe==FALSE){
                    ...
                    $oPersonal=new Personal($codigo,$nombre,$apellido,$cargo);						
                    $oPersonal->crear();
                
                    
                    
                    echo mensajes('El Personal "'.$nombre.'" Ha Sido Registrado Con Exito','verde');
                }
                else
                ...
                if($existe==TRUE)
                {
                    ...
                    $oPersonal=new Personal($codigo,$nombre,$apellido,$cargo);
                    $oPersonal->actualizar();
    	
                                       
                    echo mensajes('El Personal "'.$nombre.'" Ha Sido Actualizado Con Exito','verde');
                }
            }
        ?>
                ...
                <td>
                	...
                	<div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <input type="text" name="apellido" value="<?php echo $apellido; ?>" required class="input-large" autocomplete="off"><br>
                            ...
                            <select name="cargo" >
                                ...
                                <?php
                                    ...
                                    {
                                        echo "<option value ='".$consulta_cargo['codigo']."'>".$consulta_cargo['nombre']."</option>" ;
                                    } 
                                ?>
                            </select><br>
